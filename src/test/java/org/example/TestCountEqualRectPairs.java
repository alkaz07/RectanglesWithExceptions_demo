...
public class TestCountEqualRectPairs {
    @Test
    public void testCountNumberOfPairs() throws GeometryException {
        ...
        int countOfPairs = Main.countEqualRectPairs(rectangleList);
    ...
    public void testNoPairs() throws GeometryException {
        ...
        int countPairs = Main.countEqualRectPairs(rectangles);
    ...
    void testManyPairs() throws GeometryException {
        ...
        Assertions.assertEquals(7,Main.countEqualRectPairs(list));
    }
}